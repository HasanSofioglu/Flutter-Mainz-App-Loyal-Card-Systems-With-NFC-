...
class EditPage extends StatefulWidget {
  ...
  String idRest;
  String typeSelect;
  EditPage({Key key, @required this.idRest, this.typeSelect, this.shoeData})
      : super(key: key);
  @override
  _EditPageState createState() => _EditPageState(idRest, typeSelect);
}
...
class _EditPageState extends State<EditPage> {
  ...
  _EditPageState(String idRest, String typeSelect);
  ...
  Widget build(BuildContext context) {
    _name.text = widget.shoeData.name;
    _description.text = widget.shoeData.description;
    _tagline.text = widget.shoeData.tagLine;
    _price.text = widget.shoeData.price;
    _imageurl = widget.shoeData.image;
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              ...
                              image: (file != null)
                                  ...
                                  : ((widget.shoeData.image != null)
                                      ? NetworkImage("${widget.shoeData.image}")
              ...
              buildTextField(
                  "Product Name", "${widget.shoeData.name}", false, _name),
              buildTextField("Description", "${widget.shoeData.description}",
                  false, _description),
              buildTextField(
                  "Tagline", "${widget.shoeData.tagLine}", false, _tagline),
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: widget.shoeData.price,
                      hintStyle: TextStyle(
                        fontSize: 16,
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => RestAccpage(
                                        ...
                                        typeSelect: CatalogModel.selectType,
                                      )));
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              ...
                              return AlertDialog(
                                title: new Text("Update Succesfuly"),
                                actions: <Widget>[
